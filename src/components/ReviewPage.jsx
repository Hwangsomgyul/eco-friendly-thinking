            ...
            <Header />
                <div className='m-auto items-center w-[1400px] h-[1700px] mt-[45px]'>
                    <div className='mb-[30px]'>
                        <div className='m-auto w-[300px] h-[80px] mb-[10px] rounded-xl flex flex-col justify-center items-center text-[20px] font-bold text-white bg-[#365a31]'>스타벅스 럭키비키점<br/>
                            <div className='text-[15px] font-normal'>서울 중구 퇴계로 100</div>
                        </div>
                        <div>
                            <div className='flex justify-center items-center'>
                                <div className='ml-[550px] m-auto flex justify-center items-center rounded-xl bg-[#D6EFD8] font-bold cursor-pointer hover:bg-[#508D4E] text-white w-[300px] h-[45px]'>새로운 리뷰를 등록하기 +</div>
